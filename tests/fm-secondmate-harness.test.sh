...
test_spawn_bare_harness_no_model_effort_flag() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "CLAUDE_CODE_SEND_FEEDBACK=0 '$w/tmux-sm/fakebin/claude' --dangerously-skip-permissions" \
...
test_spawn_secondmate_harness_model_token() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "'$w/tmux-sm/fakebin/claude' --dangerously-skip-permissions --settings '{\"feedbackDrafts\":\"off\",\"disableRemoteControl\":true}' --model 'opus'" \
...
test_spawn_secondmate_harness_model_and_effort_tokens() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "'$w/tmux-sm/fakebin/claude' --dangerously-skip-permissions --settings '{\"feedbackDrafts\":\"off\",\"disableRemoteControl\":true}' --model 'opus' --effort 'high'" \
